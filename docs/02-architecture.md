...
| Ready-made shop (Phase 9D) | Category `/shop` after 9C; guest checkout; simple variants; COD + online; webhook-authoritative payment; SKU stock not WMS; **9D-A FROZEN** (ADR-0030); **9D-B catalogue/inventory admin foundation** (DEC-0089); public `/shop` **not started** |
