...
select results_eq(
  ...
  array[49],
  'Public schema must contain exactly the 49 authorized application tables (identity + portfolio + lead intake + Phase 5B CRM + Phase 5D bulk import + Phase 5E sales targets + Phase 6A WhatsApp + Phase 6B send-intent + Phase 6B dispatch + Phase 6C Kriti + Phase 6D staff attendance leave — 9 public domain tables)'
);
