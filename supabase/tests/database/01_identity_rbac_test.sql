...
select results_eq(
  ...
  array[28],
  'Public schema must contain exactly the 28 authorized application tables (identity + portfolio + lead intake + Phase 5B CRM + Phase 5D bulk import + Phase 5E sales targets)'
);
