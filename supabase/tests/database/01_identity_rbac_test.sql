...
select results_eq(
  ...
  array[10],
  'Should have exactly 10 seeded system roles including the isolated commerce_vendor account role'
);
...
select results_eq(
  ...
  array[174],
  'Public schema must contain exactly 174 authorized application tables including the reviewed CRM/WhatsApp P1-P3 additions'
);
