...
select results_eq(
  ...
  array[97],
  'Public schema must contain exactly the 97 authorized application tables (identity + portfolio + lead intake + Phase 5B CRM + Phase 5D bulk import + Phase 5E sales targets + Phase 6A WhatsApp + Phase 6B send-intent + Phase 6B dispatch + Phase 6C Kriti + Phase 6D staff attendance leave + Phase 7A commercial draft + Phase 7B finalization delivery acceptance + Phase 8A projects + Phase 8B design + Phase 8C execution + Phase 9A campaigns + Phase 9B landing lab + Phase 9C-B execution + Phase 9C-C metrics/feedback + Phase 9D-B commerce catalogue/inventory)'
);
