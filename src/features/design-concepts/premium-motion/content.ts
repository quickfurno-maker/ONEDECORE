/**
 * Phase 2F-R4 "Premium Motion Conversion Homepage" — concept-isolated content.
 *
...
export const PM_HREF = "/design-concepts/premium-motion-homepage" as const;
export const PM_CONCEPT_ID = "premium-motion" as const;
...
export const PM_ASSETS = {
  hero: {
    path: "/marketing/r4/hero-living-warmth.webp",
    width: 1536,
    height: 1024,
  ...
  completeHomeInteriors: {
    path: "/marketing/r4/service-complete-home-interiors.webp",
    width: 1536,
    height: 1024,
  ...
  modularKitchens: {
    path: "/marketing/r4/service-modular-kitchens.webp",
    width: 1536,
    height: 1024,
  ...
  customWardrobes: {
    path: "/marketing/r4/service-custom-wardrobes.webp",
    width: 1536,
    height: 1024,
  ...
  materialStone: {
    path: "/marketing/r4/material-travertine-bronze.webp",
    width: 1536,
    height: 1024,
  ...
  materialTimber: {
    path: "/marketing/r4/material-oak-joinery.webp",
    width: 1500,
    height: 1000,
  ...
  materialTexture: {
    path: "/marketing/r4/material-fluted-texture.webp",
    width: 1400,
    height: 933,
  ...
  dusk: {
    path: "/marketing/r4/support-dusk-detail.webp",
    width: 1536,
    height: 1024,
...
export const PM_PLANNER = {
  ...
  steps: [
    ...
    { id: 4, legend: "How can we reach you?", short: "Contact" },
  ],
  services: [
  ...
  editDetailsLabel: PM_CTA.editDetails,
...
export const PM_CLOSE = {
  ...
  secondaryHref: "/portfolio",
  successTitle: PM_PLANNER.successTitle,
  successBody: PM_PLANNER.successBody,
  editDetailsLabel: PM_CTA.editDetails,
} as const;
...
export const PM_REVIEW = {
  tag: "R4 PREMIUM MOTION",
  notice: "Phase 2F-R4 internal review — not a public ONEDECORE page.",
...
export type PmPlannerMode = "inline" | "sheet";
