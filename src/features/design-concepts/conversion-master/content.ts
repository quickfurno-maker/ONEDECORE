/**
 * Phase 2F-R3 Conversion Master — conversion copy proposals for owner review.
...
export const CM_PLANNER = {
  ...
  submitLabel: "Request a Design Call",
  privacyMicrocopy:
  ...
  privacyConsentLabel: "I agree to the privacy note above",
  successTitle: "Thank you — your details are ready for review.",
  successBody:
    "This is a prototype confirmation. In production, your enquiry would be stored securely and followed up by the ONEDECORE team.",
  backLabel: "Back",
...
/** Conversion-clarity extensions grounded in approved SERVICE_STORIES descriptions. */
export const CM_SERVICE_MODULES = SERVICE_CARDS.map((card) => {
  const extensions: Record<
    string,
    { forWhom: string; value: string; includes: string }
  > = {
    "complete-home-interiors": {
      includes:
        "Space planning, finishes, storage, and installation considered together as one interior journey.",
      forWhom:
        "Homeowners shaping a full interior across rooms, rather than isolated pieces.",
      value:
        "A coordinated direction so rooms, storage, and finishes stay connected.",
    },
    "modular-kitchens": {
      includes:
        "Kitchen systems planned around everyday movement, practical storage, and a calm material palette.",
      forWhom: "Homes that need a thoughtfully organised kitchen as part of daily life.",
      value:
        "A kitchen that supports how you move and cook, held within the wider interior language.",
    },
    "custom-wardrobes": {
      includes:
        "Made-to-fit wardrobe compositions balancing organised storage, proportion, and material detail.",
      forWhom: "Homes needing storage that fits the architecture of the room.",
      value:
        "Wardrobes resolved as part of the interior, not as an afterthought.",
    },
  };
...
export const CM_STORY = {
  ...
  body: "Verified before-and-after pairs are not yet available in the portfolio CMS. Until then, this section presents restrained storytelling with approved marketing artwork — never a simulated slider.",
  futureNote:
    "Real before-and-after photography will be a future CMS-driven enhancement when verified pairs exist.",
} as const;

export const CM_PROCESS_CTA = "Start With Your Home" as const;

export const CM_SCOPE = {
  overline: "Scope planner",
  heading: "Build your interior brief",
  introduction:
    "A guided way to describe what you need — without prices. Your brief stays on this page until you continue to contact.",
  ...
  continueLabel: "Continue to contact",
...
export const CM_FAQS = [
  ...
  },
  {
    ...
    answer:
      "ONEDECORE designs and delivers interiors for homes across Pune.",
  },
  {
    id: "design-execution",
...
export const CM_FINAL_FORM = {
  overline: "Begin the conversation",
  heading: "Request a design call",
  lede: "Share a few details about your home. This prototype keeps everything on the page — no production submission yet.",
  submitLabel: "Request a Design Call",
  secondaryLabel: "View Portfolio",
  secondaryHref: "/portfolio",
  successTitle: "Thank you — enquiry preview saved locally.",
  successBody:
    "In production, this form would create a secure lead record for the ONEDECORE team. No response-time promise is made here.",
  whatsappConsentLabel: "Send updates about this enquiry on WhatsApp",
} as const;

export const CM_STICKY = {
  plan: "Plan My Interiors",
...
export const CM_REVIEW = {
  ...
  notice: "Phase 2F-R3 internal review — not a public ONEDECORE page.",
