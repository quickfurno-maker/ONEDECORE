...
export const WHATSAPP_CONTROL_PLANE_PERMISSIONS: readonly WhatsappControlPlanePermission[] = [
  ...
  // ---- WhatsApp control-plane codes (inserted by WM-2 … WM-6 migrations) ---
  {
    code: "whatsapp.templates.read",
    area: "templates",
    risk: "read",
    status: "existing",
    source: "20260913140000_whatsapp_template_studio_utility_send.sql",
    grantedTo: SA_SM,
  ...
  },
  {
    ...
    risk: "bulk",
    status: "existing",
    source: "20260914100000_whatsapp_contacts_consent_segments_policy.sql",
    grantedTo: SA_SM,
  ...
  },
  {
    ...
    risk: "bulk",
    status: "existing",
    source: "20260915100000_whatsapp_campaign_execution.sql",
    grantedTo: SA_SM,
  ...
  },
  {
    ...
    risk: "read",
    status: "existing",
    source: "20260917100000_whatsapp_analytics_attribution.sql",
    grantedTo: SA_SM,
  ...
  },
  {
    ...
    risk: "read",
    status: "existing",
    source: "20260918100000_whatsapp_automations_flows_referrals.sql",
    grantedTo: SA_SM,
