  ...
  return (
    <main className="od-shop">
      ...
      <section className="od-shop__section" aria-labelledby="shop-interiors">
        ...
        <p>
          Interiors and modular kitchens are planned on the homepage consultation path. Furniture
          browsing does not create a CRM lead.
        </p>
        <p>
          <Link href="/">Explore interiors</Link>
          {" · "}
